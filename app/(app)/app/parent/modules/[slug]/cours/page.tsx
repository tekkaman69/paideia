...
import { LessonReader, type LessonSection } from '@/components/modules/LessonReader'
import type { Module } from '@/types'

export default async function ParentCoursPage({
  params,
}: {
  ...
  if (!mod.lesson_sections || mod.lesson_sections.length === 0) {
    return (
      <div className="p-6 max-w-2xl mx-auto text-center py-20">
        ...
        <p className="text-gray-500 text-sm">Le contenu de ce module est en cours de rédaction.</p>
      </div>
    )
  }
