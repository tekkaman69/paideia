        ...
        <Card className="border-0 shadow-sm">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                id="title"
                placeholder="Ex: Maîtriser les tables de multiplication"
                {...form.register('title')}
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                {form.formState.errors.xp_reward && (
                  <p className="text-xs text-red-600">{form.formState.errors.xp_reward.message}</p>
                )}
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader className="pb-3 pt-5">
            <CardTitle className="text-base">
              Icône
              <span className="ml-2 text-base font-normal">{selectedIcon}</span>
            </CardTitle>
          </CardHeader>
          <CardContent>
              ...
              {GOAL_ICONS.map(icon => (
                <button
                  ...
                  className={`w-10 h-10 rounded-xl text-xl transition-all ${
                    selectedIcon === icon
                      ? 'bg-primary-100 ring-2 ring-primary-500 shadow-sm'
